...
#define VENOM_PACKAGE_FLAG_TURBOJS_BRIDGE 32768u
#define VENOM_PACKAGE_FLAG_SCRIPT_ISOLATION 65536u
#define VENOM_PACKAGE_FLAG_SCRIPT_POLICY 131072u
#define VENOM_PACKAGE_FLAG_TURBOJS_CHUNKS 262144u
#define VENOM_PACKAGE_FLAG_TURBOJS_ENGINE 524288u
#define VENOM_PACKAGE_FLAG_SCRIPT_ENGINE_FALLBACK 1048576u
#define VENOM_PACKAGE_FLAG_TURBOJS_ENGINE_MODULE 2097152u
#define VENOM_PACKAGE_FLAG_TURBOJS_CONTEXT_LIFECYCLE 4194304u
#define VENOM_PACKAGE_FLAG_HOST_CAPABILITIES 8388608u
#define VENOM_PACKAGE_FLAG_TURBOJS_ADAPTER_DIAGNOSTICS 16777216u
#define VENOM_PACKAGE_FLAG_TURBOJS_WASM_RUNTIME 33554432u
#define VENOM_PACKAGE_FLAG_TURBOJS_SOURCE_TRANSFER 67108864u
#define VENOM_PACKAGE_FLAG_TURBOJS_CONSOLE_BRIDGE 134217728u
#define VENOM_PACKAGE_FLAG_TURBOJS_EXECUTION_RECORDS 268435456u
#define VENOM_PACKAGE_FLAG_TURBOJS_RESULT_BRIDGE 536870912u
#define VENOM_PACKAGE_FLAG_TURBOJS_FALLBACK_POLICY 1073741824u
#define VENOM_PACKAGE_FLAG_TURBOJS_ENGINE_BACKEND 2147483648u
...
#define VENOM_SECTION_TURBOJS 6u
...
#define VENOM_SECTION_TURBOJS_BRIDGE 17u
#define VENOM_SECTION_SCRIPT_ISOLATION 18u
#define VENOM_SECTION_SCRIPT_POLICY 19u
#define VENOM_SECTION_TURBOJS_CHUNKS 20u
#define VENOM_SECTION_TURBOJS_ENGINE 21u
#define VENOM_SECTION_SCRIPT_ENGINE_POLICY 22u
#define VENOM_SECTION_TURBOJS_ENGINE_MODULE 23u
#define VENOM_SECTION_TURBOJS_CONTEXT_LIFECYCLE 24u
#define VENOM_SECTION_HOST_CAPABILITIES 25u
#define VENOM_SECTION_TURBOJS_ADAPTER_DIAGNOSTICS 26u
#define VENOM_SECTION_TURBOJS_WASM_RUNTIME 27u
#define VENOM_SECTION_TURBOJS_SOURCE_TRANSFER 28u
#define VENOM_SECTION_TURBOJS_CONSOLE_BRIDGE 29u
#define VENOM_SECTION_TURBOJS_EXECUTION_RECORDS 30u
#define VENOM_SECTION_TURBOJS_RESULT_BRIDGE 31u
#define VENOM_SECTION_TURBOJS_FALLBACK_POLICY 32u
#define VENOM_SECTION_TURBOJS_ENGINE_BACKEND 33u
#define VENOM_SECTION_TURBOJS_NATIVE_PARITY 34u
#define VENOM_SECTION_TURBOJS_EXECUTION_MODE 35u
#define VENOM_SECTION_TURBOJS_RUNTIME_ABI 36u
#define VENOM_SECTION_TURBOJS_HOST_IMPORTS 37u
#define VENOM_SECTION_TURBOJS_HEAP_LIMITS 38u
#define VENOM_SECTION_TURBOJS_SCRIPT_BUFFER 39u
#define VENOM_SECTION_TURBOJS_CONSOLE_ABI 40u
#define VENOM_SECTION_TURBOJS_PARITY_PROBE 41u
#define VENOM_SECTION_TURBOJS_RELEASE_FALLBACK 42u
#define VENOM_SECTION_TURBOJS_BYTECODE_MANIFEST 43u
#define VENOM_SECTION_TURBOJS_MODULE_RESOLVER 44u
#define VENOM_SECTION_TURBOJS_EXCEPTION_ABI 45u
#define VENOM_SECTION_TURBOJS_HOST_TRAP_POLICY 46u
#define VENOM_SECTION_TURBOJS_EXECUTION_LIFECYCLE 47u
#define VENOM_SECTION_TURBOJS_SCRIPT_BUFFER_POLICY 48u
#define VENOM_SECTION_TURBOJS_CONTEXT_LIMIT_POLICY 49u
#define VENOM_SECTION_TURBOJS_HOST_CALL_DISPATCH 50u
#define VENOM_SECTION_TURBOJS_PARITY_CONTRACT 51u
#define VENOM_SECTION_TURBOJS_RELEASE_FAILCLOSED 52u
#define VENOM_SECTION_TURBOJS_MODULE_GRAPH 53u
#define VENOM_SECTION_TURBOJS_MODULE_EXECUTION 54u
#define VENOM_SECTION_TURBOJS_MODULE_CACHE 55u
#define VENOM_SECTION_TURBOJS_RESOLVER_AUDIT 56u
#define VENOM_SECTION_TURBOJS_INTEROP_FALLBACK 57u
#define VENOM_SECTION_TURBOJS_EXECUTION_PIPELINE 58u
#define VENOM_SECTION_TURBOJS_SCRIPT_RECORDS 59u
#define VENOM_SECTION_TURBOJS_EVAL_RESULTS 60u
#define VENOM_SECTION_TURBOJS_CONSOLE_CAPTURE 61u
#define VENOM_SECTION_TURBOJS_FAILURE_REPORTS 62u
#define VENOM_SECTION_TURBOJS_EXECUTION_JOURNAL 63u
#define VENOM_SECTION_TURBOJS_CHECKPOINT_POLICY 64u
#define VENOM_SECTION_TURBOJS_REPLAY_CURSOR 65u
#define VENOM_SECTION_TURBOJS_RESUME_STATE 66u
#define VENOM_SECTION_TURBOJS_DETERMINISM_AUDIT 67u
#define VENOM_SECTION_TURBOJS_SNAPSHOT_POLICY 68u
#define VENOM_SECTION_TURBOJS_SNAPSHOT_RECORDS 69u
#define VENOM_SECTION_TURBOJS_REPLAY_VALIDATION 70u
#define VENOM_SECTION_TURBOJS_DETERMINISM_LEDGER 71u
#define VENOM_SECTION_TURBOJS_AUDIT_SEAL 72u
#define VENOM_SECTION_TURBOJS_EXECUTION_COMMIT 73u
#define VENOM_SECTION_TURBOJS_ROLLBACK_POLICY 74u
#define VENOM_SECTION_TURBOJS_HOST_CALL_RECEIPTS 75u
#define VENOM_SECTION_TURBOJS_RELEASE_ACCEPTANCE 76u
#define VENOM_SECTION_TURBOJS_COMMIT_AUDIT 77u
#define VENOM_SECTION_TURBOJS_CAPABILITY_POLICY 78u
#define VENOM_SECTION_TURBOJS_HOST_IO_POLICY 79u
#define VENOM_SECTION_TURBOJS_PERMISSION_SEAL 80u
#define VENOM_SECTION_TURBOJS_POLICY_RECEIPTS 81u
#define VENOM_SECTION_TURBOJS_RELEASE_GATE 83u
#define VENOM_SECTION_TURBOJS_HOST_IO_DECISION 83u
#define VENOM_SECTION_TURBOJS_HOST_IO_DENY_TRACE 84u
#define VENOM_SECTION_TURBOJS_CAPABILITY_LEDGER 85u
#define VENOM_SECTION_TURBOJS_POLICY_SEAL_AUDIT 86u
#define VENOM_SECTION_TURBOJS_RUNTIME_DENYLIST 87u
...
#define VENOM_LOGICAL_CALL_TURBOJS 8u
...
static int parse_package_image(const unsigned char* bytes, uint64_t size, struct VenomPackageImage* image) {
  ...
  const uint32_t known_flags = VENOM_PACKAGE_FLAG_PROTECT | VENOM_PACKAGE_FLAG_RELEASE |
    ...
    VENOM_PACKAGE_FLAG_EVENT_QUEUE | VENOM_PACKAGE_FLAG_TURBOJS_BRIDGE |
    VENOM_PACKAGE_FLAG_SCRIPT_ISOLATION | VENOM_PACKAGE_FLAG_SCRIPT_POLICY | VENOM_PACKAGE_FLAG_TURBOJS_CHUNKS |
    VENOM_PACKAGE_FLAG_TURBOJS_ENGINE | VENOM_PACKAGE_FLAG_SCRIPT_ENGINE_FALLBACK |
    VENOM_PACKAGE_FLAG_TURBOJS_ENGINE_MODULE | VENOM_PACKAGE_FLAG_TURBOJS_CONTEXT_LIFECYCLE |
    VENOM_PACKAGE_FLAG_HOST_CAPABILITIES | VENOM_PACKAGE_FLAG_TURBOJS_ADAPTER_DIAGNOSTICS |
    VENOM_PACKAGE_FLAG_TURBOJS_WASM_RUNTIME | VENOM_PACKAGE_FLAG_TURBOJS_SOURCE_TRANSFER |
    VENOM_PACKAGE_FLAG_TURBOJS_CONSOLE_BRIDGE | VENOM_PACKAGE_FLAG_TURBOJS_EXECUTION_RECORDS |
    VENOM_PACKAGE_FLAG_TURBOJS_RESULT_BRIDGE | VENOM_PACKAGE_FLAG_TURBOJS_FALLBACK_POLICY |
    VENOM_PACKAGE_FLAG_TURBOJS_ENGINE_BACKEND;
...
static int execute_route_text(const struct VenomRouteEntry* route, const struct VenomVmBytecode* vm, const struct VenomStringTable* strings, const struct VenomPolyMap* poly, VenomRuntimeReport* report) {
  ...
  while (pc < end) {
    ...
    switch (op) {
      ...
      case VENOM_LOGICAL_CALL_TURBOJS:
