...
async function executeScriptsForRoute(route, jsBundle, scriptIsolationPlan = null, scriptPolicyPlan = null, quickJsChunkPlan = null, quickJsEnginePlan = null, scriptEnginePolicyPlan = null) {
  ...
  for (const chunk of selected) {
    // Keep script execution deterministic: execute in document order. Async is preserved as metadata
    // and becomes true concurrent scheduling once the QuickJS/WASM runtime is connected.
