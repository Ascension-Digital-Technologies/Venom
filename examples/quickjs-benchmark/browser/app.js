...
async function runSuite() {
  ...
  log("Warm-up: protected bridge and persistent QuickJS context.");
  ...
  try {
    ...
    setStatus("ready", "QuickJS benchmark complete");
...
async function boot() {
  ...
  log("Protected QuickJS/WASM benchmark runtime initialized.");
}
