...
def main():
    ...
    header,docs=render(data); outputs={root/'src/generated/include/venom/generated/runtime/host_api_contract.h':header, root/'docs/generated/host-api-contract.md':docs}
    bad=[]
