...
def main() -> int:
    ...
    stages.extend([
        ...
        python_stage(root, "TurboJS/WASM authoritative contract", "tests/package/turbojs-wasm-authoritative-contract-smoke.py"),
        python_stage(root, "Generated TurboJS engine ABI", "tests/package/turbojs-engine-generated-abi-smoke.py"),
