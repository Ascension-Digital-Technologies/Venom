...
Generator inputs live in `src/**/templates/` or `third_party/`; generated implementation snapshots live in `src/generated/`, while generated C/C++ contracts are exported from `src/generated/`.
