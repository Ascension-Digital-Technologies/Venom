...
Venom 2.0.0 emits preload hints for the loader, browser runtime, protected package, QuickJS/WASM module, and worker. These hints start immutable asset transfers earlier without introducing a plaintext application cache. Normal HTTP caching remains available for content-addressed production assets.
