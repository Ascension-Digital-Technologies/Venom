...
```bash
python tools/verify_chrome_extension_store.py examples/chrome-extension/dist-venom
```
...
```bash
python tools/package_chrome_extension.py examples/chrome-extension/dist-venom --out-dir release/chrome-extension
```
