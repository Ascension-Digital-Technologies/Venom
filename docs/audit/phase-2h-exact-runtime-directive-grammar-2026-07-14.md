...
A typo can no longer silently select an unintended runtime. Runtime-like malformed directives fail before planning, rewriting, TurboJS compilation, or package emission.
