...
Production closure enforcement now rejects empty candidate IDs, duplicate candidate IDs, unresolved records, and resolved intents without a native TurboJS registry record. New diagnostics are `VNM-PROT-1002` through `VNM-PROT-1005`.
