...
Venom's TurboJS and package runtimes still require exported WebAssembly memory for the current Emscripten ABI. A browser owner can therefore inspect memory with sufficient instrumentation. Venom does not claim otherwise.
