...
with tempfile.TemporaryDirectory() as td:
 ...
 build={'product':'Venom','venom_version':'test','profile':'prod','security_target':'browser','runtime_abi_version':12,'package_format_version':1,'package_asset':'assets/app/app.vbc','package_sha256':'x','protection_closure':{'requested':1,'resolved':1,'registry_present':True,'whole_file_intents':0,'expected_turbojs_records':1}}
