...
subprocess.run([sys.executable, str(root/'tools/route_wasm_provenance.py'), '--header', str(root/'src/generated/runtime/wasm_runtime_blob.hpp'), '--out', str(root/'src/generated/runtime/metadata/wasm_runtime_provenance.json'), '--check'], check=True)
