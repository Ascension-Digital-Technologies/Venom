...
for token in ('manifest_version','unsafe-eval','web_accessible_resources','high-impact permissions','venom-chrome-store-readiness-v1','JavaScript contains source comments','CHROME_RUNTIME_URL_RE','chrome.runtime.getURL target'):
