...
checks = {
    ...
    'wasm install required': 'QuickJS release runtime lacks live diversification support' in engine,
    'wasm contract installer': 'venom_qjs_diversification_install' in scaffold,
