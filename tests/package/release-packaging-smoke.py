...
def main() -> int:
    ...
    required = [
        ...
        out / 'tools' / 'turbojs_wasm_preflight.py',
        out / 'tools' / 'turbojs_wasm_cutover.py',
        out / 'tools' / 'setup_emscripten.py',
        out / 'licenses' / 'TURBOJS-LICENSE',
    ]
