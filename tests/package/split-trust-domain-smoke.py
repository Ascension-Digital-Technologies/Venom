...
required_runtime=["bytecodeTrustHandoff", "producer: 'package-decoder-wasm'", "consumer: 'turbojs-execution-wasm'", "bindingHash: fnv1a32"]
required_engine=["validateBytecodeTrustHandoff", "TurboJS trust-domain handoff integrity mismatch", "validateBytecodeTrustHandoff(chunk)"]
