...
if len(sys.argv) != 4:
    print('usage: turbojs-upstream-intrinsic-semantics-smoke.py <venom> <site> <out>')
    raise SystemExit(2)
...
for export in [
    ...
    b'venom_tjs_upstream_intrinsic_record_ptr',
    b'venom_tjs_upstream_intrinsic_semantics_score',
    b'venom_tjs_upstream_property_descriptor_record_ptr',
    b'venom_tjs_upstream_prototype_chain_record_ptr',
    b'venom_tjs_upstream_call_frame_record_ptr',
]:
