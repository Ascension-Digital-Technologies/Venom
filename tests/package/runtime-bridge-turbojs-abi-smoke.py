...
release = (root/'tools/turbojs_release_abi.py').read_text(encoding='utf-8')
for name in (
...
assert 'if (!turboJsInstance || !turboJsContext)' in worker
print('[venom] TurboJS protected function bridge ABI: PASS')
