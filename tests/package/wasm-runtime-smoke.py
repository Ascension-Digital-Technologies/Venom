...
turbojs_engine_files = sorted(assets.glob('turbojs-engine*.js'))
if len(turbojs_engine_files) != 1: raise SystemExit('expected exactly one turbojs-engine asset')
...
if turbojs_engine_files[0].name not in loader: raise SystemExit('loader does not pass generated TurboJS engine filename')
...
required = [
    ...
    'script-policy',
    'turbojs-chunks',
    'turbojs-engine-module',
    'turbojs-context-lifecycle',
    'host-capabilities',
    'turbojs-adapter-diagnostics',
    'host_bridge name="s.',
    'fetch_bridge name="s.',
    'timer_bridge name="s.',
    'event_queue name="s.',
    'turbojs_bridge name="s.',
    'script_isolation name="s.',
    'script_policy name="s.',
    'turbojs_chunks name="s.',
    'turbojs_engine_module name="s.',
    'turbojs_context_lifecycle name="s.',
    'host_capabilities name="s.',
    'turbojs_adapter_diagnostics name="s.',
    'async_host_queue name="s.',
    'turbojs_execution_records name="s.',
    'turbojs_result_bridge name="s.',
    'turbojs_fallback_policy name="s.',
    'turbojs_engine_backend name="s.',
    'turbojs_runtime_denylist name="s.',
]
for forbidden in (
    'runtime-policy.vhrd', 'host-calls.vhcb', 'fetch-bridge.vfch', 'timer-bridge.vtmr',
    'event-queue.vevq', 'turbojs-bridge.vtjs', 'script-isolation.vsis', 'script-policy.vscp',
    'turbojs-chunks.vqbc', 'turbojs-engine-module.vqem', 'turbojs-runtime-denylist.vqrd'
):
