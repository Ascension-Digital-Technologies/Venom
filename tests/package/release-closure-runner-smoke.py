...
ps=(root/'scripts'/'windows'/'release-closure.ps1').read_text(encoding='utf-8')
sh=(root/'scripts'/'linux'/'release-closure.sh').read_text(encoding='utf-8')
required=(
 'final_release_gate.py','release_closure.py','cmake','ctest',
 'doctor-production','protected-chess','nova-trade','bot-detection','analyze','check-production-leaks.py',
