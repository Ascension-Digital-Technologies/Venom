...
authored = (root / "src/runtime/js/quickjs-engine/00-module-contract.js").read_text(encoding="utf-8")
worker = (root / "src/generated/runtime/worker_runtime_template.inc").read_text(encoding="utf-8")
