...
authored = (root / "src/templates/turbojs-engine/00-module-contract.js").read_text(encoding="utf-8")
worker = (root / "src/generated/runtime/worker_runtime_template.hpp").read_text(encoding="utf-8")
generated = (root / "src/generated/runtime/turbojs_engine_module.cpp").read_text(encoding="utf-8")
...
print("turbojs release export allowlist smoke: PASS")
