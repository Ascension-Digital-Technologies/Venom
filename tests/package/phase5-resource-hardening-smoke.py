...
scaffold = (root/'src/runtime/quickjs_runtime_scaffold.c').read_text()
...
checks = {
  ...
  'interrupt handler': 'JS_SetInterruptHandler' in scaffold and 'venom_qjs_interrupt_handler' in scaffold,
  'pending job ceiling': 'pending_job_limit' in scaffold and 'pending job limit exceeded' in scaffold,
  'secure arena wipe': 'venom_qjs_secure_zero(g_source' in scaffold,
  'execution limits export': 'venom_qjs_context_set_execution_limits' in scaffold and 'venom_qjs_context_set_execution_limits' in abi,
