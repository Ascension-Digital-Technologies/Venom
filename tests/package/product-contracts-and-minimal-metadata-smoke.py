...
for key in ('package_format_version','package_runtime_abi','route_vm_contract','dom_command_contract','turbojs_runtime_abi','host_bridge_abi','configuration_schema','lockfile_schema'):
...
for section in ('TurboJsParityProbe','TurboJsParityContract','TurboJsModuleCache','TurboJsResolverAudit','TurboJsExecutionPipeline','TurboJsEvalResults','TurboJsConsoleCapture','TurboJsFailureReports'):
