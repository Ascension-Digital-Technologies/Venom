...
for marker in ['upstreamTurboJsReady', 'upstreamParityRecord', 'upstreamObjectModelScore', 'turbojs-wasm-abi12-upstream-global-host-api-shims']:
    if marker not in engine:
        raise SystemExit(f'turbojs engine module missing upstream marker: {marker}')

print('TurboJS upstream runtime bridge smoke passed')
