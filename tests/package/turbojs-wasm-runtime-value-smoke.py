...
def main() -> int:
    if len(sys.argv) != 3:
        print('usage: turbojs-wasm-runtime-value-smoke.py <repo-root> <out-dir>', file=sys.stderr)
        return 2
    ...
    manifest = out / 'turbojs-runtime-values.manifest.txt'
    exports_json = out / 'turbojs-runtime-values.exports.json'
    ...
    print('turbojs wasm runtime value smoke: PASS')
    return 0
