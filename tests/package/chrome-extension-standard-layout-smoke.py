...
assert 'shell_path(file.relative)' in emitter
assert 'shell_path("venom-extension-rpc.js")' in emitter
assert 'shell_path("engine.html")' in emitter
...
assert 'std::filesystem::remove(generated_index, remove_error)' in emitter
