...
for path in sorted(src.rglob("*")):
    ...
    if "raise_error(" in text and path.suffix in {".cpp", ".cc", ".cxx"} and '#include "base/error.hpp"' not in text:
...
error_header = (root / "src/base/error.hpp").read_text(encoding="utf-8")
diagnostic_header = (root / "src/core/diagnostic.hpp").read_text(encoding="utf-8")
