...
engine=root/'src/templates/turbojs-engine'
expected_browser={
 '00-contracts.js','10-package-loader.js','20-runtime-contracts.js','30-host-queues.js',
 '40-turbojs-bridge.js','50-browser-modules.js','60-route-runtime.js'}
expected_engine={
...
assert 'function createTurboJsEngine' in (browser/'40-turbojs-bridge.js').read_text()
